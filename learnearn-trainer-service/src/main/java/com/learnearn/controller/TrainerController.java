...
public class TrainerController {
	...
	ResponseEntity<Trainer> getById(int trainerId) {
		HttpHeaders headers=new HttpHeaders();
	...
	ResponseEntity<List<Trainer>> getByCourseNameAndTrainerName(String courseName, String trainerName) {
		HttpHeaders headers=new HttpHeaders();
	...
	ResponseEntity<List<Trainer>> getByCourseNameAndAvailability(String courseName, PostAvailability availability) {
		HttpHeaders headers=new HttpHeaders();
	...
	ResponseEntity<Trainer> assignTrainer(int courseId, int trainerId) {
		HttpHeaders headers=new HttpHeaders();
	...
	ResponseEntity<Trainer> deAssignTrainer(int trainerId) {
		HttpHeaders headers=new HttpHeaders();
		headers.add("desc","deassign Trainers By trainerId");
		headers.add("info","Returning deassigned Trainers By trainerId");
		Trainer trainer= trainerService.deAssignTrainer(trainerId);
		return ResponseEntity.ok().headers(headers).body(trainer);
	}
}
